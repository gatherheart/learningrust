        ...
        <section className="grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(340px,0.75fr)]">
          <div className="rounded-[30px] border border-white/10 bg-zinc-950/85 p-6 shadow-2xl shadow-black/25">
            ...
            <div className="mt-4 max-w-3xl space-y-3 text-base leading-8 text-zinc-300">
              <p>This section is for explanation-heavy Rust interview reasoning beyond syntax and borrow-checker slogans.</p>
              <p>The emphasis is on ownership tradeoffs, traits, lifetimes, async, unsafe, concurrency, and when to redesign code rather than fight the compiler.</p>
            </div>
          </div>
          <div className="rounded-[30px] border border-white/10 bg-[#0d1117] p-5 shadow-2xl shadow-black/20">
            ...
            <div className="space-y-3 text-sm leading-7 text-zinc-300">
              <p>Junior questions check ownership, borrowing, and core type-system reasoning.</p>
              <p>Mid questions focus on API design, trait bounds, lifetimes, async, and concurrency semantics.</p>
              <p>Senior questions shift toward unsafe boundaries, architecture, performance, and design tradeoffs.</p>
            </div>
          </div>
        </section>
